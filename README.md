About flask-compress-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flask-compress-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flask-compress-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flask-compress
# for installing globally
pixi global install flask-compress
```
...
It is possible to list all of the versions of `flask-compress` available on your platform:
...
```
pixi search flask-compress --channel conda-forge
```
